...
**Style**: feature | **Duration**: ~597s | **Photos**: 7
...
npx hyperframes render --output ../history-of-computing-documentary.mp4

# Draft render (fast for iteration):
npx hyperframes render --output ../history-of-computing-documentary-draft.mp4 --quality draft
